        ...
        $.ajax({
            ...
            success: function(data){
                if(data == 1){
                    ...
                    $('#qty_error_'+itemId).html('');
                    net_amount();
                    net_qty();
                }else{ 
                    $('.item-qty').val(parseInt(qty) - parseInt(1));
...
let navbar = document.querySelector('#header-menu .menu-list');

document.querySelector('.humberger .fa-bars').onclick = () =>{
