        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control product_description" name="product_desc" rows="8" cols="80"></textarea>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control product_qty" name="product_qty" alue="">
                </div>
                <div class="form-group">
                    <label>Status</label>
